...
fun AddOutfitScreen(
    ...
    lastWornText: String,
    selectedClothingCount: Int,
    snackbarHostState: SnackbarHostState,
    onPickLastWorn: () -> Unit,
    onChooseClothing: () -> Unit,
    ...
    var selectedSeason by rememberSaveable {
        mutableStateOf(
            initialSeason?.takeIf { it.isNotBlank() } ?: seasons.firstOrNull().orEmpty()
        )
    }
            ...
            TopAppBar(
                title = {
                    Row(
                        ...
                        Icon(
                            painter = androidx.compose.ui.res.painterResource(R.drawable.ic_heart),
            ...
            Button(
                onClick = {
                    if (title.isBlank()) {
                        ...
                        onSave(title, description, selectedSeason)
                    }
                },
                modifier = Modifier.fillMaxWidth()
            ) {
